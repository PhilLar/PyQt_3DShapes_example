...
class Window(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.btnDel = QtWidgets.QPushButton('Выбрать объект и удалить')
        # CREATE 3DVIEW ##########################
        ...
        self.vbox.addLayout(self.codeEx)
        self.vbox.addLayout(self.btnsBox)

        self.vbox.addWidget(logTextBox.widget)
